...
* medication	1..1	Reference(Medication)	"What medication was taken SNOMED CT Medication Codes (Example)" ""
* subject	1..1	Reference(Patient or Group)	"Who is/was taking the medication" ""
* encounter	0..1	Reference(Encounter)	"Encounter associated with MedicationUsage" ""
...
//* derivedFrom 0..* Reference()	"Link to information used to derive the MedicationUsage" ""
...
Logical:        BeModelMedicationRecordAdminsitration
...
* partOf 0..* Reference(MedicationAdministration or Procedure)	"Part of referenced event" ""
...
* medication 1..1 Reference(Medication)	"What was administered SNOMED CT Medication Codes (Example)" ""
* subject 1..1 Reference(Patient or Group) "Who received medication" ""
